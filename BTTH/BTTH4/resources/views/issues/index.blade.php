                            ...
                            <tr>
                                ...
                                <td>
                                    <span
										...
										@elseif ($issue->urgency === 'High') text-danger fw-bold @endif">
                                ...
                                <td>
									...
									@elseif ($issue->status === 'Resolved') text-primary fw-bold @endif">

                                        {{ $issue->status }}
                                    </span>
                                </td>
                                <td>
                                    <a href="{{ route('issues.edit', $issue->id) }}"><button type="button"
